        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="px-6 bg-white border-b border-gray-200">
                    ...
                    <div class="px-5">
                        <img id="imgHolder" width="500" alt="" src="{{ asset('storage/'.$blog->img) }}">
                        <button class="btn bg-red-500 p-3 mt-3" onclick="removeImage()" id="removeBtn">Remove Image</button>
                    </div>
                    ...
                    @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="border-2 border-gray-300 p-2 w-full" name="title" id="title" value="{{$blog->title}}" required></input>
                        </div>
